const config = {
  ...
  title: 'Frontend Mentor: Ping single column coming soon page',
  // Project short name. Used by PWA
  shortTitle: 'FM Ping coming soon page',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Ping single column coming soon page" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-ping-coming-soon-page.netlify.app',
